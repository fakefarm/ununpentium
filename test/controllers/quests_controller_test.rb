...
class QuestsControllerTest < ActionController::TestCase
  ...
  test "should create quest" do
    assert_difference('Quest.count') do
      post :create, quest: { description: @quest.description, name: @quest.name, permalink: @quest.permalink, price: @quest.price, user_id: @quest.user_id }
    end
  ...
  test "should update quest" do
    patch :update, id: @quest, quest: { description: @quest.description, name: @quest.name, permalink: @quest.permalink, price: @quest.price, user_id: @quest.user_id }
    assert_redirected_to quest_path(assigns(:quest))
  end
